        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            ...
            <span class="navbar-text">
              ...
              <a href="../login/welcome.php"><button class="btn btn-outline-primary">Regresar</button></a>
                  <?php
                }else{
               ?>
...
<body>
  <div>
    <h2>Crear y Eliminar</h2>


<table align="center" border="2" class="default">
...
<?php $resultado = mysqli_query($conn, $sql);  
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td><a align="right" href="nuevo.php"><button class="btn btn-outline-primary">Crear Nuevo Usuario</button></a> </td>
  </tr>
  <tr>
    <td>Cargo</td>
  </tr>
